...
LaserBullet::LaserBullet(Engine::Point position, Engine::Point forwardDirection, float damage, float rotation, Turret *parent) : Bullet("play/bullet-2.png", 800, damage, position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
}
...
Bullet *LaserBullet::CreateBulletForSimulate() const
{
    ...
    return new LaserBullet(Position, forwardDirection, damage, Rotation, parent);
}